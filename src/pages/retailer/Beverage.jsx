...
export default function Beverage() {
  ...
  // console.log("data category : ", productByCategoryData);
           ...
           >
                  <div className="w-full flex flex-col justify-center items-center ">
                    ...
                    <div className="w-full mt-1 text-center">
                      ...
                      <p className="text-orange-500 lg:font-semibold font-medium lg:text-lg text-sm mt-2">
                        ${item.price}/pack
                      </p>
                      {/* qty  */}
                      <p
                        className={`text-gray-500 lg:font-medium font-normal lg:text-base text-sm mt-1 ${
